...
const RATES = { BRL:1, ARS:220, CLP:170, UYU:7.8, PYG:1450, USD:0.19, EUR:0.17, BOB:1.32, PEN:0.72, COP:760 };

const TRIP = {
  name: "Floripa → Bariloche", origin: "Florianópolis, SC", dest: "Bariloche, ARG",
  days: 12, km: 2180, people: 4, budget: 8000,
  stops: [
    { id:1, name:"Florianópolis", day:1, type:"origin", lat:-27.60, lng:-48.55, notes:"Partida 6h", hours:0, weather:{temp:26,icon:"⛅",cond:"Parcial nublado",wind:14,hi:28,lo:21}, tourism:[] },
    { id:2, name:"Lages", day:1, type:"stop", lat:-27.82, lng:-50.33, notes:"Almoço + combustível", hours:3, weather:{temp:18,icon:"🌥️",cond:"Nublado",wind:22,hi:20,lo:10}, tourism:[{name:"Morro da Igreja",type:"Mirante",time:"1h",free:true}] },
    { id:3, name:"Paso Pehuenche", day:2, type:"border", lat:-35.97, lng:-70.39, notes:"Fronteira — docs obrigatórios", hours:8, weather:{temp:8,icon:"🌬️",cond:"Frio intenso",wind:35,hi:10,lo:-2}, tourism:[] },
    { id:4, name:"Malargüe", day:2, type:"camping", lat:-35.48, lng:-69.59, notes:"Camping municipal · ARS 5.000", hours:10, weather:{temp:12,icon:"☀️",cond:"Frio e seco",wind:28,hi:14,lo:2},
    ...
    { id:5, name:"San Rafael", day:3, type:"stop", lat:-34.62, lng:-68.33, notes:"Bodega Zuccardi + combustível", hours:4, weather:{temp:22,icon:"☀️",cond:"Ensolarado",wind:10,hi:25,lo:12},
    ...
    { id:6, name:"Mendoza", day:4, type:"city", lat:-32.89, lng:-68.85, notes:"2 noites · Camping Suizo", hours:5, weather:{temp:24,icon:"☀️",cond:"Ensolarado",wind:12,hi:26,lo:13},
    ...
    { id:7, name:"Neuquén", day:6, type:"stop", lat:-38.95, lng:-68.06, notes:"Pernoite · Ruta 40", hours:7, weather:{temp:16,icon:"🌬️",cond:"Ventoso",wind:25,hi:18,lo:6},
      tourism:[{name:"Ruta 40 Patagônica",type:"Rota cênica",time:"Full day",free:true}] },
    { id:8, name:"Villa La Angostura", day:8, type:"camping", lat:-40.76, lng:-71.65, notes:"Camping Correntoso · lago", hours:5, weather:{temp:8,icon:"🌧️",cond:"Chuvoso",wind:15,hi:10,lo:2},
    ...
    { id:9, name:"Bariloche", day:9, type:"destination", lat:-41.13, lng:-71.31, notes:"3 noites · Camping Petunia", hours:2, weather:{temp:6,icon:"❄️",cond:"Neve leve",wind:18,hi:8,lo:-2},
        ...
        {w && (
          <div className="stop-wx">
            ...
            <div>
              ...
              <div className="stop-wx-cond">{w.cond}</div>
            </div>
...
function RoutePage() {
  ...
  return (
    <div>
      ...
      {view === 'timeline' && (
        <>
          {generated && <div className="al ok fu f1">✅ Roteiro gerado — 12 dias, 9 paradas, 4.5h/dia de direção. Toque em cada parada para detalhes.</div>}
          <div className="ss" style={{marginTop:0}}>Floripa → Bariloche · {TRIP.stops.length} paradas · Clima + turismo + camping integrados</div>
          {TRIP.stops.map(s => (
